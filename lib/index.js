 ...
 * @param {string[]} [options.shapeTypes] The types of shapes to use when generating the image, available are: `Circle`, `Cubic`, `Ellipse`, `Line`, `Quadratic`, `Rect`, `RotatedRect`, `Square` and `Triangle`
