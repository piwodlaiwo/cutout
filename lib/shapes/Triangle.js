...
class Triangle {
  constructor(xBound, yBound) {
    ...
    this.x2 = this.x1 + randomIntInclusive(0, 30) - 15;
    this.y2 = this.y1 + randomIntInclusive(0, 30) - 15;
    this.x3 = this.x1 + randomIntInclusive(0, 30) - 15;
    this.y3 = this.y1 + randomIntInclusive(0, 30) - 15;
  }
  ...
  rasterize() {
    const [x1, y1, x2, y2, x3, y3] = this.props;
    const shape = { type: 'polygon', points: `${x1},${y1} ${x2},${y2} ${x3},${y3}` };
