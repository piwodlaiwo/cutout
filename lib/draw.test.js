...
it.skip('draws a rectangle on top of an image', () => {
...
it.skip('skips invalid rectangle pixel coordinates', () => {
  const fixture = path.join(__dirname, '..', 'test', 'fixtures', 'rectangle-skip');
  const output = path.join(fixture, 'output');
  const expected = path.join(fixture, 'expected');
